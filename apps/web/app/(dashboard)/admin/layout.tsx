...
const AdminSidebar = ({
  ...
  user?: AdminDashboardLayoutProps['user'];
}) => {
  return (
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {unreadNotifications && unreadNotifications > 0 && (
            <Badge className="absolute -top-1 -right-1 h-5 w-5 rounded-full p-0 text-xs flex items-center justify-center bg-green-500 text-white border-0">
