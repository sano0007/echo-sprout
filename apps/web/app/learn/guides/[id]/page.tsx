...
export default function GuideSlidesPage() {
  ...
  const prev = () =>
    setIndex((i) => (count === 0 ? 0 : i === 0 ? count - 1 : i - 1));
  const next = () =>
    setIndex((i) => (count === 0 ? 0 : i === count - 1 ? 0 : i + 1));
          ...
          <div>
            ...
            {(!form?.photos || form.photos.length === 0) && (
              <p className="text-sm text-gray-500">
                No photos added. Click "Add Photo".
              </p>
            )}
                ...
                <div key={idx} className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setForm((f: any) => ({
                        ...f,
                        photos: f.photos.map((p: string, i: number) =>
