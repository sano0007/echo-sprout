    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md min-h-96">
                {currentStep === 0 && (
                    <div>
                        ...
                        <div className="space-y-4">
                            <input type="text" placeholder="Project Name" className="w-full p-3 border rounded"/>
                            ...
                            <textarea placeholder="Project Description"
                                      className="w-full p-3 border rounded h-32"></textarea>
                            <input type="number" placeholder="Expected Carbon Credits"
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <input type="text" placeholder="Key Milestone 1" className="p-3 border rounded"/>
                                <input type="date" className="p-3 border rounded"/>
                                <input type="text" placeholder="Key Milestone 2" className="p-3 border rounded"/>
                                <input type="date" className="p-3 border rounded"/>
                            </div>
                        </div>
                    </div>
                ...
                {currentStep === 2 && (
                    <div>
                        ...
                        <div className="space-y-4">
                            <input type="text" placeholder="Project Address" className="w-full p-3 border rounded"/>
                            <div className="grid grid-cols-2 gap-4">
                            ...
                            <input type="number" placeholder="Area Size (hectares)"
                                   className="w-full p-3 border rounded"/>
                            <textarea placeholder="Environmental Impact Details"
                                      className="w-full p-3 border rounded h-32"></textarea>
                        </div>
                    </div>
                )}
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="border-2 border-dashed border-gray-300 p-8 text-center">
                                ...
                                <p className="text-sm text-gray-600">Supported formats: PDF, JPG, PNG, DOC (Max
                                    50MB)</p>
                            </div>
            ...
            <div className="flex justify-between mt-6">
                ...
                <button
                    onClick={currentStep === steps.length - 1 ? () => alert('Project submitted!') : nextStep}
