    ...
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="bg-blue-600 text-white p-6">
        <h2 className="text-2xl font-bold">
          {existingUpdate ? 'Resubmit Progress Update' : 'Submit Progress Update'}
        </h2>
        <p className="text-blue-100 mt-1">Project ID: {projectId}</p>
      </div>

      {/* Revision Notes Banner */}
      {existingUpdate?.status === 'needs_revision' && existingUpdate?.reviewNotes && (
        <div className="bg-orange-50 border-l-4 border-orange-500 p-4 mx-6 mt-4">
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <h3 className="text-sm font-medium text-orange-800">Revision Required</h3>
              <div className="mt-2 text-sm text-orange-700">
                <p><strong>Verifier's Notes:</strong> {existingUpdate.reviewNotes}</p>
                <p className="mt-2">Please address the feedback above and resubmit your progress update.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Drag and drop or click to select files (Images: JPG, PNG | Documents: PDF, max 10MB each)
                </p>
              </div>
                      ...
                      {isPDF ? (
                        <div className="w-full h-full flex items-center justify-center bg-gray-100 rounded-lg border-2 border-gray-300">
                          <div className="text-center">
                            ...
                            <p className="text-xs mt-1 text-gray-600 truncate px-2">{file?.name}</p>
                          </div>
                        </div>
                      ) : (
                      <Image
