    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md text-center">
                    <p className="text-2xl font-bold text-purple-600">{stats.averageReviewTime}</p>
                    ...
                    {activeTab === 'inProgress' && (
                        ...
                        <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm">
                          ...
                          Verifier: {project.verifier}
                                                ...
                                                <span className="text-sm text-gray-600">
                          Started: {new Date(project.submitted).toLocaleDateString()}
                        </span>
                                            </div>
                                        </div>
                                        <div className="flex gap-2">
                    ...
                    {activeTab === 'completed' && (
                        ...
                        <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm">
                          {project.type}
                                                ...
                                                <span className={`px-2 py-1 rounded text-sm ${
                                                    project.result === 'Approved' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                }`}>
                          {project.result}
                        </span>
                                                <span className="text-sm text-gray-600">
