              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="text-center">
                      ...
                      <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
                          The world's most transparent carbon credit marketplace connecting project developers,
                          verifiers, and buyers in the fight against climate change.
                      </p>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="text-center mb-16">
                      ...
                      <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                          From project registration to trading and monitoring, our platform provides
                          comprehensive tools for the carbon credit lifecycle.
                      </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                      <div className="text-center">
                          ...
                          <p className="text-gray-600">
                              Register, track, and manage your carbon projects with our comprehensive dashboard
                      ...
                      <div className="text-center">
                          ...
                          <h3 className="text-xl font-semibold mb-3">Rigorous Verification</h3>
                          <p className="text-gray-600">
                              Our certified verifiers ensure all projects meet international standards
                              including VCS, Gold Standard, and CCBS.
                          </p>
                      </div>
                      ...
                      <div className="text-center">
                          ...
                          <h3 className="text-xl font-semibold mb-3">Transparent Marketplace</h3>
                          <p className="text-gray-600">
                              Buy and sell carbon credits with full transparency, detailed project information,
          ...
          <section className="py-20 bg-gray-900 text-white">
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                  ...
                  <p className="text-xl mb-8">
                      Join thousands of organizations already using EcoSprout to achieve their climate goals.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <Link
                          href="/auth/register"
