declare const _default: import('convex/server').SchemaDefinition<
  {
      ...
      import('convex/values').VObject<
        ...
        },
        {
          ...
          notificationPreferences: import('convex/values').VObject<
            ...
            | undefined,
            {
              channels: import('convex/values').VArray<
                ...
                import('convex/values').VUnion<
                  'email' | 'in_app' | 'sms',
                  [
                    import('convex/values').VLiteral<'email', 'required'>,
                    import('convex/values').VLiteral<'in_app', 'required'>,
                    import('convex/values').VLiteral<'sms', 'required'>,
                  ],
                  'required',
                  never
                >,
              ...
              alertTypes: import('convex/values').VObject<
                ...
                {
                  progress_reminders: import('convex/values').VBoolean<
                    boolean,
                    'required'
                  >;
                  milestone_delays: import('convex/values').VBoolean<
                    boolean,
                    'required'
                  >;
                  system_alerts: import('convex/values').VBoolean<
                    boolean,
                    'required'
                  >;
                  escalations: import('convex/values').VBoolean<
                    boolean,
                    'required'
                  >;
                  weekly_reports: import('convex/values').VBoolean<
                    boolean,
                    'required'
                  >;
                },
              ...
              quietHours: import('convex/values').VObject<
                ...
                | undefined,
                {
                  enabled: import('convex/values').VBoolean<
                    boolean,
                    'required'
                  >;
              ...
              frequency: import('convex/values').VObject<
                ...
                {
                  immediate: import('convex/values').VBoolean<
                    boolean,
                    'required'
                  >;
            ...
            | 'quietHours'
            | 'frequency'
            | 'alertTypes.progress_reminders'
            | 'alertTypes.milestone_delays'
            | 'alertTypes.system_alerts'
            | 'alertTypes.escalations'
            | 'alertTypes.weekly_reports'
            | 'quietHours.enabled'
            | 'quietHours.start'
            | 'quietHours.end'
            | 'quietHours.timezone'
            ...
            | 'frequency.weekly'
          >;
          preferencesUpdatedAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          phone: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
        ...
        | 'notificationPreferences.alertTypes'
        | 'notificationPreferences.quietHours'
        | 'notificationPreferences.frequency'
        | 'notificationPreferences.alertTypes.progress_reminders'
        | 'notificationPreferences.alertTypes.milestone_delays'
        | 'notificationPreferences.alertTypes.system_alerts'
        | 'notificationPreferences.alertTypes.escalations'
        | 'notificationPreferences.alertTypes.weekly_reports'
        ...
        | 'notificationPreferences.frequency.hourly'
        ...
        },
        {
          ...
          location: import('convex/values').VObject<
            ...
            },
            {
              ...
              city: import('convex/values').VString<
                string | undefined,
                'optional'
              >;
              country: import('convex/values').VString<
                string | undefined,
                'optional'
              >;
            },
            'required',
            'city' | 'country' | 'name' | 'lat' | 'long'
          >;
          ...
          actualCompletionDate: import('convex/values').VString<
            ...
            'optional'
          >;
          milestone1: import('convex/values').VObject<
            | {
                name: string;
                date: string;
              }
            ...
            'name' | 'date'
          >;
          milestone2: import('convex/values').VObject<
            | {
                name: string;
                date: string;
              }
          ...
          progressPercentage: import('convex/values').VFloat64<
            ...
            'optional'
          >;
          lastProgressUpdate: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          projectImages: import('convex/values').VArray<
            any[] | undefined,
            import('convex/values').VAny<any, 'required', string>,
            'optional'
          >;
    ...
    transactions: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        ...
        },
        {
          ...
          projectId: import('convex/values').VId<
            import('convex/values').GenericId<'projects'> | undefined,
            'optional'
          >;
          creditAmount: import('convex/values').VFloat64<number, 'required'>;
          ...
          refundDetails: import('convex/values').VObject<
            ...
            | undefined,
            {
              ...
              refundAmount: import('convex/values').VFloat64<
                number,
                'required'
              >;
            ...
            'optional',
            'refundReason' | 'refundAmount' | 'adminNotes' | 'processedAt'
          >;
        },
        'required',
        | 'projectId'
    ...
    verifications: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        ...
        },
        {
          ...
          status: import('convex/values').VUnion<
            ...
            [
              ...
              import('convex/values').VLiteral<'accepted', 'required'>,
              import('convex/values').VLiteral<'in_progress', 'required'>,
              import('convex/values').VLiteral<'completed', 'required'>,
              import('convex/values').VLiteral<'approved', 'required'>,
              import('convex/values').VLiteral<'rejected', 'required'>,
          ...
          environmentalImpact: import('convex/values').VObject<
            ...
            | undefined,
            {
              carbonReductionValidated: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              methodologyVerified: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              calculationsAccurate: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              score: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
              notes: import('convex/values').VString<
                string | undefined,
                'optional'
              >;
            },
            'optional',
            | 'carbonReductionValidated'
            | 'methodologyVerified'
          ...
          projectFeasibility: import('convex/values').VObject<
            ...
            | undefined,
            {
              timelineAssessed: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              budgetAnalyzed: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              technicalApproachValid: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              resourcesAvailable: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              score: import('convex/values').VFloat64<
          ...
          documentationQuality: import('convex/values').VObject<
            ...
            | undefined,
            {
              completenessCheck: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              accuracyVerified: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              complianceValidated: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              formatStandards: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              score: import('convex/values').VFloat64<
          ...
          locationVerification: import('convex/values').VObject<
            ...
            | undefined,
            {
              geographicDataConfirmed: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              landRightsVerified: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              accessibilityAssessed: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              environmentalSuitability: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              score: import('convex/values').VFloat64<
          ...
          sustainability: import('convex/values').VObject<
            ...
            | undefined,
            {
              longTermViabilityAnalyzed: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              maintenancePlanReviewed: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              stakeholderEngagement: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              adaptabilityAssessed: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              score: import('convex/values').VFloat64<
            ...
            | 'score'
            | 'notes'
            | 'longTermViabilityAnalyzed'
            | 'maintenancePlanReviewed'
            | 'stakeholderEngagement'
            | 'adaptabilityAssessed'
          >;
          ...
          documentAnnotations: import('convex/values').VArray<
            ...
            import('convex/values').VObject<
              ...
              {
                documentId: import('convex/values').VId<
                ...
                annotations: import('convex/values').VArray<
                  ...
                  import('convex/values').VObject<
                    ...
                    },
                    {
                      ...
                      content: import('convex/values').VString<
                        string,
                        'required'
                      >;
                      position: import('convex/values').VObject<
                        ...
                        {
                          pageNumber: import('convex/values').VFloat64<
                            number,
                            'required'
                          >;
                          x: import('convex/values').VFloat64<
                            number,
                            'required'
                          >;
                          y: import('convex/values').VFloat64<
                            number,
                            'required'
                          >;
                          width: import('convex/values').VFloat64<
                            number | undefined,
                            'optional'
                          >;
                          height: import('convex/values').VFloat64<
                            number | undefined,
                            'optional'
                          >;
                        },
                      ...
                      >;
                      author: import('convex/values').VString<
                        string,
                        'required'
                      >;
                      timestamp: import('convex/values').VFloat64<
                        number,
                        'required'
                      >;
                    },
            ...
            'optional'
          >;
          overallScore: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          confidenceLevel: import('convex/values').VUnion<
            'low' | 'high' | 'medium' | undefined,
            [
              import('convex/values').VLiteral<'low', 'required'>,
              import('convex/values').VLiteral<'medium', 'required'>,
              import('convex/values').VLiteral<'high', 'required'>,
            ],
            'optional',
            never
          >;
          recommendationJustification: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
        },
        ...
        | 'environmentalImpact.carbonReductionValidated'
        | 'environmentalImpact.methodologyVerified'
        | 'environmentalImpact.calculationsAccurate'
        | 'environmentalImpact.score'
        | 'environmentalImpact.notes'
        | 'projectFeasibility.score'
        | 'projectFeasibility.notes'
        | 'projectFeasibility.timelineAssessed'
        | 'projectFeasibility.budgetAnalyzed'
        | 'projectFeasibility.technicalApproachValid'
        | 'projectFeasibility.resourcesAvailable'
        | 'documentationQuality.score'
        | 'documentationQuality.notes'
        | 'documentationQuality.completenessCheck'
        | 'documentationQuality.accuracyVerified'
        | 'documentationQuality.complianceValidated'
        | 'documentationQuality.formatStandards'
        | 'locationVerification.score'
        | 'locationVerification.notes'
        | 'locationVerification.geographicDataConfirmed'
        | 'locationVerification.landRightsVerified'
        | 'locationVerification.accessibilityAssessed'
        | 'locationVerification.environmentalSuitability'
        | 'sustainability.score'
        | 'sustainability.notes'
        | 'sustainability.longTermViabilityAnalyzed'
        | 'sustainability.maintenancePlanReviewed'
        | 'sustainability.stakeholderEngagement'
    ...
    documents: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        ...
        {
          entityId: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          ...
          media: import('convex/values').VObject<
            ...
            {
              storageId: import('convex/values').VString<
                string | undefined,
                'optional'
              >;
              fileUrl: import('convex/values').VString<
                string | undefined,
                'optional'
              >;
            ...
            'required',
            'storageId' | 'fileUrl' | 'cloudinary_public_id' | 'cloudinary_url'
          >;
          thumbnailUrl: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          description: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          documentType: import('convex/values').VUnion<
            ...
            | 'other',
            [
              import('convex/values').VLiteral<'project_proposal', 'required'>,
              import('convex/values').VLiteral<
                'environmental_impact',
                'required'
              >,
              import('convex/values').VLiteral<'site_photographs', 'required'>,
              import('convex/values').VLiteral<'legal_permits', 'required'>,
              import('convex/values').VLiteral<'featured_images', 'required'>,
              import('convex/values').VLiteral<'site_images', 'required'>,
    ...
    educationalContent: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        ...
        },
        {
          ...
          tags: import('convex/values').VArray<
            ...
            'required'
          >;
          images: import('convex/values').VArray<
            string[] | undefined,
            import('convex/values').VString<string, 'required'>,
            'optional'
          >;
      ...
      {}
    >;
    learningPaths: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          publishedAt?: number | undefined;
        ...
        },
        {
          title: import('convex/values').VString<string, 'required'>;
          description: import('convex/values').VString<string, 'required'>;
          objectives: import('convex/values').VArray<
            string[] | undefined,
            import('convex/values').VString<string, 'required'>,
            'optional'
          >;
          level: import('convex/values').VUnion<
            'beginner' | 'intermediate' | 'advanced',
            [
              import('convex/values').VLiteral<'beginner', 'required'>,
              import('convex/values').VLiteral<'intermediate', 'required'>,
            ...
            never
          >;
          estimatedDuration: import('convex/values').VFloat64<
            number,
            'required'
          >;
          tags: import('convex/values').VArray<
            ...
            'required'
          >;
          visibility: import('convex/values').VUnion<
            'public' | 'private' | 'unlisted',
            [
              import('convex/values').VLiteral<'public', 'required'>,
              import('convex/values').VLiteral<'private', 'required'>,
              import('convex/values').VLiteral<'unlisted', 'required'>,
            ],
            'required',
            never
          >;
          coverImageUrl: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          createdBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'>,
            'required'
          >;
          status: import('convex/values').VUnion<
            ...
            [
              import('convex/values').VLiteral<'draft', 'required'>,
              import('convex/values').VLiteral<'published', 'required'>,
              import('convex/values').VLiteral<'archived', 'required'>,
            ],
            'required',
            never
          >;
      ...
      {}
    >;
    learningPathLessons: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          description?: string | undefined;
        ...
        {
          pathId: import('convex/values').VId<
            import('convex/values').GenericId<'learningPaths'>,
            'required'
          >;
          title: import('convex/values').VString<string, 'required'>;
          description: import('convex/values').VString<
            ...
            'optional'
          >;
          videoUrl: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          pdfUrls: import('convex/values').VArray<
            string[],
            import('convex/values').VString<string, 'required'>,
            'required'
          >;
    ...
    forumReplies: import('convex/server').TableDefinition<
      ...
      {}
    >;
    learningProgress: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          completedAt?: number | undefined;
          completed: boolean;
        ...
        },
        {
          ...
          pathId: import('convex/values').VId<
            ...
            'required'
          >;
          lessonId: import('convex/values').VId<
            import('convex/values').GenericId<'learningPathLessons'>,
            'required'
          >;
          itemType: import('convex/values').VUnion<
            'video' | 'pdf',
            [
              import('convex/values').VLiteral<'video', 'required'>,
              import('convex/values').VLiteral<'pdf', 'required'>,
            ],
            'required',
            never
          >;
      ...
      {}
    >;
    forumReplyVotes: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          userId: import('convex/values').GenericId<'users'>;
        ...
        {
          replyId: import('convex/values').VId<
            import('convex/values').GenericId<'forumReplies'>,
            'required'
          >;
          userId: import('convex/values').VId<
            import('convex/values').GenericId<'users'>,
            'required'
          >;
          value: import('convex/values').VUnion<
            1 | -1,
            [
              import('convex/values').VLiteral<1, 'required'>,
              import('convex/values').VLiteral<-1, 'required'>,
            ],
            'required',
            never
    ...
    certificates: import('convex/server').TableDefinition<
      ...
      {}
    >;
    verificationCertificates: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
        ...
        },
        {
          ...
          certificateNumber: import('convex/values').VString<
            ...
            'required'
          >;
          certificateType: import('convex/values').VUnion<
            'approval' | 'quality_assessment' | 'environmental_compliance',
            [
              import('convex/values').VLiteral<'approval', 'required'>,
              import('convex/values').VLiteral<
                'quality_assessment',
                'required'
              >,
          ...
          >;
          issueDate: import('convex/values').VFloat64<number, 'required'>;
          validUntil: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          certificateUrl: import('convex/values').VString<string, 'required'>;
          ...
          verificationDetails: import('convex/values').VObject<
            ...
            },
            {
              ...
              categoryScores: import('convex/values').VObject<
                ...
                {
                  environmental: import('convex/values').VFloat64<
                    number,
                    'required'
                  >;
                  feasibility: import('convex/values').VFloat64<
                    number,
                    'required'
                  >;
                  documentation: import('convex/values').VFloat64<
                    number,
                    'required'
                  >;
                  location: import('convex/values').VFloat64<
                    number,
                    'required'
                  >;
                  sustainability: import('convex/values').VFloat64<
                    number,
                    'required'
                  >;
                },
                ...
                | 'documentation'
              >;
              verifierCredentials: import('convex/values').VString<
                string,
                'required'
              >;
              verificationStandard: import('convex/values').VString<
                string,
                'required'
              >;
              complianceLevel: import('convex/values').VUnion<
                'basic' | 'standard' | 'premium',
                [
                  import('convex/values').VLiteral<'basic', 'required'>,
                  import('convex/values').VLiteral<'standard', 'required'>,
                  import('convex/values').VLiteral<'premium', 'required'>,
                ],
                'required',
                never
              >;
            ...
            | 'categoryScores.sustainability'
            | 'categoryScores.environmental'
            | 'categoryScores.feasibility'
          ...
          revokedAt: import('convex/values').VFloat64<
            ...
            'optional'
          >;
          revokedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          revocationReason: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
        },
        ...
        | 'revokedBy'
        | 'revocationReason'
        | 'verificationDetails.overallScore'
        | 'verificationDetails.categoryScores'
        | 'verificationDetails.verifierCredentials'
        | 'verificationDetails.verificationStandard'
        | 'verificationDetails.complianceLevel'
        | 'verificationDetails.categoryScores.location'
        | 'verificationDetails.categoryScores.sustainability'
        | 'verificationDetails.categoryScores.environmental'
        | 'verificationDetails.categoryScores.feasibility'
        | 'verificationDetails.categoryScores.documentation'
      >,
      {
        by_verification: ['verificationId', '_creationTime'];
        by_project: ['projectId', '_creationTime'];
    ...
    auditLogs: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        ...
        },
        {
          ...
          severity: import('convex/values').VUnion<
            ...
            [
              import('convex/values').VLiteral<'info', 'required'>,
              import('convex/values').VLiteral<'warning', 'required'>,
              import('convex/values').VLiteral<'error', 'required'>,
              import('convex/values').VLiteral<'critical', 'required'>,
            ],
            'optional',
            never
          >;
      ...
      {}
    >;
    verificationAuditLogs: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
        ...
        },
        {
          ...
          verifierId: import('convex/values').VId<
            ...
            'required'
          >;
          action: import('convex/values').VUnion<
            | 'verification_assigned'
            | 'verification_accepted'
            | 'verification_started'
            | 'checklist_updated'
            ...
            [
              ...
              import('convex/values').VLiteral<
                ...
                'required'
              >,
              import('convex/values').VLiteral<'checklist_updated', 'required'>,
              import('convex/values').VLiteral<
                'document_annotated',
                'required'
              >,
              import('convex/values').VLiteral<'score_calculated', 'required'>,
              import('convex/values').VLiteral<'message_sent', 'required'>,
              import('convex/values').VLiteral<
                'verification_completed',
                'required'
              >,
          ...
          details: import('convex/values').VObject<
            ...
            {
              section: import('convex/values').VString<
                string | undefined,
                'optional'
              >;
              previousValue: import('convex/values').VAny<
                any,
                'optional',
                string
              >;
            ...
            | `newValue.${string}`
          >;
          ipAddress: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          userAgent: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          sessionId: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
        ...
        | 'details.newValue'
        | `details.previousValue.${string}`
        | `details.newValue.${string}`
      >,
      {
        by_verification: ['verificationId', '_creationTime'];
        by_verifier: ['verifierId', '_creationTime'];
    ...
    notifications: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          ...
          parentNotificationId?:
            | import('convex/values').GenericId<'notifications'>
            | undefined;
        ...
        },
        {
          ...
          message: import('convex/values').VString<string, 'required'>;
          type: import('convex/values').VString<string, 'required'>;
          severity: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          category: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          channels: import('convex/values').VArray<
            ...
            'required'
          >;
          scheduledAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          sentAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          deliveredAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          readAt: import('convex/values').VFloat64<
          ...
          failureReason: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          template: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          ...
          relatedEntityType: import('convex/values').VUnion<
            ...
            [
              ...
              import('convex/values').VLiteral<'alert', 'required'>,
              import('convex/values').VLiteral<'escalation', 'required'>,
            ],
            'optional',
            never
          >;
          ...
          metadata: import('convex/values').VAny<any, 'optional', string>;
          isRead: import('convex/values').VBoolean<boolean, 'required'>;
          isArchived: import('convex/values').VBoolean<
            boolean | undefined,
            'optional'
          >;
          tags: import('convex/values').VArray<
            ...
            'optional'
          >;
          batchId: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          parentNotificationId: import('convex/values').VId<
            import('convex/values').GenericId<'notifications'> | undefined,
            'optional'
          >;
          isTest: import('convex/values').VBoolean<
            boolean | undefined,
            'optional'
          >;
        },
      ...
      {}
    >;
    notificationTemplates: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          type: string;
          isActive: boolean;
        ...
        },
        {
          ...
          type: import('convex/values').VString<string, 'required'>;
          category: import('convex/values').VString<string, 'required'>;
          defaultChannels: import('convex/values').VArray<
            string[],
            import('convex/values').VString<string, 'required'>,
            'required'
          >;
          variables: import('convex/values').VArray<
            string[],
            import('convex/values').VString<string, 'required'>,
            'required'
          >;
          ...
          createdBy: import('convex/values').VId<
            ...
            'required'
          >;
          lastModifiedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'>,
            'required'
          >;
      ...
      {}
    >;
    userNotificationPreferences: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          quietHours?:
            | {
          ...
          alertTypes: import('convex/values').VObject<
            ...
            },
            {
              ...
              weekly_reports: import('convex/values').VBoolean<
                ...
                'required'
              >;
              verification_updates: import('convex/values').VBoolean<
                boolean,
                'required'
              >;
              project_updates: import('convex/values').VBoolean<
                boolean,
                'required'
              >;
              transaction_notifications: import('convex/values').VBoolean<
                boolean,
                'required'
              >;
            },
        ...
        | 'userId'
        | 'lastUpdated'
        | 'alertTypes.verification_updates'
        | 'alertTypes.project_updates'
    ...
    analytics: import('convex/server').TableDefinition<
      ...
      {}
    >;
    projectMilestones: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
        ...
        },
        {
          projectId: import('convex/values').VId<
            ...
            'required'
          >;
          milestoneType: import('convex/values').VUnion<
            | 'verification'
            | 'setup'
            | 'progress_25'
            | 'progress_50'
            ...
            | 'completion',
            [
              import('convex/values').VLiteral<'setup', 'required'>,
              import('convex/values').VLiteral<'progress_25', 'required'>,
              import('convex/values').VLiteral<'progress_50', 'required'>,
              import('convex/values').VLiteral<'progress_75', 'required'>,
              import('convex/values').VLiteral<'impact_first', 'required'>,
              import('convex/values').VLiteral<'verification', 'required'>,
          ...
          actualDate: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          status: import('convex/values').VUnion<
            'completed' | 'pending' | 'in_progress' | 'delayed' | 'skipped',
            [
              import('convex/values').VLiteral<'pending', 'required'>,
              import('convex/values').VLiteral<'in_progress', 'required'>,
              import('convex/values').VLiteral<'completed', 'required'>,
              import('convex/values').VLiteral<'delayed', 'required'>,
              import('convex/values').VLiteral<'skipped', 'required'>,
            ],
            'required',
            never
          >;
          delayReason: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          impactOnTimeline: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          order: import('convex/values').VFloat64<number, 'required'>;
      ...
      {}
    >;
    systemAlerts: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          description?: string | undefined;
          projectId?: import('convex/values').GenericId<'projects'> | undefined;
        ...
        },
        {
          ...
          description: import('convex/values').VString<
            ...
            'optional'
          >;
          source: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          category: import('convex/values').VString<
          ...
          resolvedAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          resolvedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          resolutionNotes: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          resolutionType: import('convex/values').VUnion<
            'fixed' | 'acknowledged' | 'dismissed' | 'duplicate' | undefined,
            [
              import('convex/values').VLiteral<'fixed', 'required'>,
              import('convex/values').VLiteral<'acknowledged', 'required'>,
              import('convex/values').VLiteral<'dismissed', 'required'>,
              import('convex/values').VLiteral<'duplicate', 'required'>,
            ],
            'optional',
            never
          >;
          assignedTo: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          assignedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          assignedAt: import('convex/values').VFloat64<
          ...
          lastEscalationTime: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          nextEscalationTime: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          autoEscalationEnabled: import('convex/values').VBoolean<
            boolean | undefined,
            'optional'
          >;
          escalatedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          escalationReason: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          deEscalatedAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          deEscalatedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          deEscalationReason: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          urgencyScore: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          estimatedResolutionTime: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          occurrenceCount: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          firstOccurrence: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          lastOccurrence: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          reopenedAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          reopenedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          reopenReason: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          metadata: import('convex/values').VAny<any, 'optional', string>;
          lastUpdatedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          lastUpdatedAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
        },
      ...
      {}
    >;
    monitoringConfig: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          description?: string | undefined;
          isActive: boolean;
    ...
    escalationConfig: import('convex/server').TableDefinition<
              ...
              escalationChain: import('convex/values').VArray<
                ...
                import('convex/values').VObject<
                  ...
                  },
                  {
                    ...
                    roles: import('convex/values').VArray<
                      string[],
                      import('convex/values').VString<string, 'required'>,
                      'required'
                    >;
                    delayMinutes: import('convex/values').VFloat64<
                      number,
                      'required'
                    >;
                    specificUsers: import('convex/values').VArray<
                      import('convex/values').GenericId<'users'>[] | undefined,
                      import('convex/values').VId<
                        import('convex/values').GenericId<'users'>,
                        'required'
                      >,
                      'optional'
                  ...
                  'required',
                  'level' | 'roles' | 'delayMinutes' | 'specificUsers'
                >,
                'required'
              >;
              maxEscalationLevel: import('convex/values').VFloat64<
                number,
                'required'
              >;
              autoEscalationEnabled: import('convex/values').VBoolean<
                ...
                'required'
              >;
              businessHoursOnly: import('convex/values').VBoolean<
                boolean | undefined,
                'optional'
              >;
              cooldownPeriod: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
            },
      ...
      {}
    >;
    emailDeliveryLog: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          deliveredAt?: number | undefined;
        ...
        },
        {
          ...
          type: import('convex/values').VString<string, 'required'>;
          status: import('convex/values').VUnion<
            'failed' | 'sent' | 'delivered' | 'bounced',
            [
              import('convex/values').VLiteral<'sent', 'required'>,
              import('convex/values').VLiteral<'delivered', 'required'>,
              import('convex/values').VLiteral<'failed', 'required'>,
              import('convex/values').VLiteral<'bounced', 'required'>,
            ],
            'required',
            never
          >;
          provider: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          providerMessageId: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          errorMessage: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
      ...
      {}
    >;
    smsDeliveryLog: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          deliveredAt?: number | undefined;
          provider?: string | undefined;
        ...
        },
        {
          ...
          type: import('convex/values').VString<string, 'required'>;
          status: import('convex/values').VUnion<
            'failed' | 'sent' | 'delivered' | 'undelivered',
            [
              import('convex/values').VLiteral<'sent', 'required'>,
              import('convex/values').VLiteral<'delivered', 'required'>,
              import('convex/values').VLiteral<'failed', 'required'>,
              import('convex/values').VLiteral<'undelivered', 'required'>,
            ],
            'required',
            never
          >;
      ...
      {}
    >;
    notificationDeliveryLog: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          alertId?:
            | import('convex/values').GenericId<'systemAlerts'>
            | undefined;
          type: string;
          timestamp: number;
          results: any;
        ...
        {
          alertId: import('convex/values').VId<
            import('convex/values').GenericId<'systemAlerts'> | undefined,
            'optional'
          >;
          type: import('convex/values').VString<string, 'required'>;
        ...
        'required',
        'type' | 'timestamp' | 'alertId' | 'results' | `results.${string}`
      >,
      {
      ...
      {}
    >;
    analyticsSnapshots: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
        ...
        },
        {
          ...
          type: import('convex/values').VUnion<
            ...
            [
              import('convex/values').VLiteral<'daily', 'required'>,
              import('convex/values').VLiteral<'weekly', 'required'>,
              import('convex/values').VLiteral<'monthly', 'required'>,
              import('convex/values').VLiteral<'quarterly', 'required'>,
            ],
            'required',
            never
          >;
          ...
          transactionData: import('convex/values').VAny<
            any,
            'required',
            string
          >;
      ...
      {}
    >;
    performanceMetrics: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          projectId?: import('convex/values').GenericId<'projects'> | undefined;
        ...
        },
        {
          ...
          type: import('convex/values').VUnion<
            'project' | 'platform' | 'user' | 'financial',
            [
              import('convex/values').VLiteral<'project', 'required'>,
              import('convex/values').VLiteral<'platform', 'required'>,
              import('convex/values').VLiteral<'user', 'required'>,
              import('convex/values').VLiteral<'financial', 'required'>,
            ],
            'required',
            never
          >;
        ...
        'required',
        'type' | 'projectId' | 'timestamp' | 'metrics' | `metrics.${string}`
      >,
      {
        by_timestamp: ['timestamp', '_creationTime'];
        by_type: ['type', '_creationTime'];
      ...
      {}
    >;
    projectPredictions: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
        ...
        },
        {
          ...
          accuracy: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
        },
      ...
      {}
    >;
    realTimeMetrics: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          systemHealth?: any;
          timestamp: number;
      ...
      {}
    >;
    marketPredictions: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          accuracy?: number | undefined;
          timestamp: number;
      ...
      {}
    >;
    userPredictions: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          accuracy?: number | undefined;
        ...
        },
        {
          ...
          prediction: import('convex/values').VAny<any, 'required', string>;
          timestamp: import('convex/values').VFloat64<number, 'required'>;
          segment: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          accuracy: import('convex/values').VFloat64<
      ...
      {}
    >;
    analyticsReports: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          expiresAt?: number | undefined;
          filters?: any;
        ...
        {
          reportType: import('convex/values').VUnion<
            | 'project_performance'
            | 'platform_analytics'
            | 'impact_summary'
            | 'user_engagement'
            ...
            [
              ...
              import('convex/values').VLiteral<
                ...
                'required'
              >,
              import('convex/values').VLiteral<'impact_summary', 'required'>,
              import('convex/values').VLiteral<'user_engagement', 'required'>,
              import('convex/values').VLiteral<'financial_metrics', 'required'>,
            ],
            'required',
            never
          >;
          ...
          generatedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'>,
            'required'
          >;
          ...
          format: import('convex/values').VUnion<
            'pdf' | 'json' | 'csv',
            [
              import('convex/values').VLiteral<'json', 'required'>,
              import('convex/values').VLiteral<'pdf', 'required'>,
              import('convex/values').VLiteral<'csv', 'required'>,
            ],
            'required',
            never
          >;
          downloadUrl: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
      ...
      {}
    >;
    pdf_reports: import('convex/server').TableDefinition<
      import('convex/values').VObject<
        {
          fileUrl?: string | undefined;
          completedAt?: number | undefined;
        ...
        {
          templateType: import('convex/values').VUnion<
            'analytics' | 'monitoring',
            [
              import('convex/values').VLiteral<'analytics', 'required'>,
              import('convex/values').VLiteral<'monitoring', 'required'>,
            ],
            'required',
            never
          >;
          ...
          fileUrl: import('convex/values').VString<
            ...
            'optional'
          >;
          fileSize: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
      ...
      import('convex/values').VObject<
        {
          ...
          photoStorageIds?:
            | import('convex/values').GenericId<'_storage'>[]
            | undefined;
        ...
        },
        {
          projectId: import('convex/values').VId<
            ...
            'required'
          >;
          submittedBy: import('convex/values').VId<
            import('convex/values').GenericId<'users'> | undefined,
            'optional'
          >;
          ...
          updateType: import('convex/values').VUnion<
            'completion' | 'milestone' | 'measurement' | 'photo' | 'issue',
            [
          ...
          progressPercentage: import('convex/values').VFloat64<
            ...
            'required'
          >;
          photoStorageIds: import('convex/values').VArray<
            ...
            'optional'
          >;
          photoUrls: import('convex/values').VArray<
            string[] | undefined,
            import('convex/values').VString<string, 'required'>,
            'optional'
          >;
          ...
          measurementData: import('convex/values').VObject<
            ...
            | undefined,
            {
              treesPlanted: import('convex/values').VFloat64<
                ...
                'optional'
              >;
              survivalRate: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
              energyGenerated: import('convex/values').VFloat64<
                ...
                'optional'
              >;
              systemUptime: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
              gasProduced: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
              wasteProcessed: import('convex/values').VFloat64<
                ...
                'optional'
              >;
              recyclingRate: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
              areaRestored: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
              mangrovesPlanted: import('convex/values').VFloat64<
                number | undefined,
                'optional'
              >;
            ...
            | 'carbonImpactToDate'
          >;
          nextSteps: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          challenges: import('convex/values').VString<
            string | undefined,
            'optional'
          >;
          submittedAt: import('convex/values').VFloat64<
            number | undefined,
            'optional'
          >;
          ...
          status: import('convex/values').VUnion<
            ...
            | undefined,
            [
              import('convex/values').VLiteral<'pending_review', 'required'>,
              import('convex/values').VLiteral<'approved', 'required'>,
              import('convex/values').VLiteral<'rejected', 'required'>,
              import('convex/values').VLiteral<'needs_revision', 'required'>,
            ],
            'optional',
            never
          >;
        ...
        | 'submittedAt'
        | 'reportingDate'
        | 'measurementData.treesPlanted'
        | 'measurementData.survivalRate'
        | 'measurementData.energyGenerated'
        | 'measurementData.systemUptime'
        | 'measurementData.gasProduced'
        | 'measurementData.wasteProcessed'
        | 'measurementData.recyclingRate'
        | 'measurementData.areaRestored'
        | 'measurementData.mangrovesPlanted'
        | 'measurementData.carbonImpactToDate'
      >,
      {
        by_project: ['projectId', '_creationTime'];
