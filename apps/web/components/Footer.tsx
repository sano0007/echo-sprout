                ...
                <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-xl font-bold">EcoSprout</span>
                        </div>
                        <p className="text-gray-400 mb-6 max-w-md">
                            Connecting project developers, verifiers, and buyers in the world's most transparent
                            carbon credit marketplace. Building a sustainable future, one credit at a time.
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p className="text-gray-400">
                                Get the latest news about carbon markets, new projects, and platform updates.
                            </p>
                        </div>
                ...
                <div className="py-6 border-t border-gray-800">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <div className="text-gray-400 text-sm">
                            © {currentYear} EcoSprout. All rights reserved.
                        </div>
