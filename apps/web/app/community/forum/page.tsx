        ...
        <div className="max-w-7xl mx-auto p-6">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-600">Connect with the carbon credit community</p>
                </div>
                            ...
                            {topContributors.map((contributor, index) => (
                                <div key={index} className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                        <p className="text-sm font-semibold text-blue-600">{contributor.reputation}</p>
                      ...
                      <span className="text-blue-600 font-semibold text-sm">
                        ...
                        <div className="p-6 border-t flex justify-center">
                            <div className="flex gap-2">
                                <button className="px-3 py-2 border rounded text-sm hover:bg-gray-100">Previous</button>
                                <button className="px-3 py-2 bg-blue-600 text-white rounded text-sm">1</button>
                                <button className="px-3 py-2 border rounded text-sm hover:bg-gray-100">2</button>
                                <button className="px-3 py-2 border rounded text-sm hover:bg-gray-100">3</button>
                                <button className="px-3 py-2 border rounded text-sm hover:bg-gray-100">Next</button>
                            </div>
                        </div>
                    </div>
                </div>
