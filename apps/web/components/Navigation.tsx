    ...
    const navigationItems = [
        {
            label: "Projects",
            dropdown: [
                {label: "Register Project", href: "/projects/register", description: "Submit your carbon project"},
                {label: "Manage Projects", href: "/projects/manage", description: "Track your projects"},
                {label: "Monitoring Dashboard", href: "/monitoring/dashboard", description: "Monitor project progress"}
            ]
        },
        {
            label: "Marketplace",
            dropdown: [
                {label: "Browse Credits", href: "/marketplace", description: "Find and purchase credits"},
                {label: "My Purchases", href: "/buyer-dashboard", description: "Track your carbon offset impact"}
            ]
        },
        {
            label: "Verification",
            dropdown: [
                ...
                {label: "Review Projects", href: "/verification/review/1", description: "Conduct project reviews"}
            ]
        },
        {
            label: "Community",
            dropdown: [
                {label: "Learning Hub", href: "/learn", description: "Educational content and courses"},
                {label: "Forum", href: "/community/forum", description: "Discussion and Q&A"}
            ]
        }
    ];
                        ...
                        {navigationItems.map((item) => (
                            ...
                            >
                                <button
                                    ...
                                    {item.label}
                                    <svg className="inline ml-1 h-4 w-4" fill="none" stroke="currentColor"
                                         viewBox="0 0 24 24">
